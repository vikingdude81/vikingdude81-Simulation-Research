...
YF_FILE_PATH_1H = SCRIPT_DIR / 'DATA' / 'yf_sol_1h.csv'
YF_FILE_PATH_4H = SCRIPT_DIR / 'DATA' / 'yf_sol_4h.csv'
YF_FILE_PATH_12H = SCRIPT_DIR / 'DATA' / 'yf_sol_12h.csv'
YF_FILE_PATH_1D = SCRIPT_DIR / 'DATA' / 'yf_sol_1d.csv'
