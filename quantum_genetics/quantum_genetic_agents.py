...
def export_genome(genome, filename='best_genome.json', metadata=None):
    ...
    # Save to data/genomes/production directory
    genome_dir = Path('data/genomes/production')
    genome_dir.mkdir(parents=True, exist_ok=True)
    abs_path = genome_dir / filename
...
def load_genome(filename='best_genome.json'):
    ...
    if not filepath.is_absolute() and not filepath.exists():
        # Try loading from data/genomes/production directory
        filepath = Path('data/genomes/production') / filename
...
def main():
    ...
    export_genome(best_agent.genome, 'best_individual_genome.json', best_metadata)
    ...
    export_genome(avg_genome, 'averaged_ensemble_genome.json', avg_metadata)
